...
K-mers are suitable for strain-resolved metagenome analysis because their absene in reference databases does not preclude their analysis. Moreover, k-mer analysis does not rely on marker genes which are largely conserved at the strain level, and k-mers are suitable for species- and strain-level classification [@doi:10.1128/mSystems.00020-16; @doi:10.1101/2022.01.11.475838]. 
