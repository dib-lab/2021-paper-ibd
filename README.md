...
[![HTML Manuscript](https://img.shields.io/badge/manuscript-HTML-blue.svg)](https://taylorreiter.github.io/2021-paper-ibd/)
[![PDF Manuscript](https://img.shields.io/badge/manuscript-PDF-blue.svg)](https://taylorreiter.github.io/2021-paper-ibd/manuscript.pdf)
[![GitHub Actions Status](https://github.com/taylorreiter/2021-paper-ibd/workflows/Manubot/badge.svg)](https://github.com/taylorreiter/2021-paper-ibd/actions)
...
When a commit to the `main` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/taylorreiter/2021-paper-ibd/tree/gh-pages) and [`output`](https://github.com/taylorreiter/2021-paper-ibd/tree/output) branches.
The `gh-pages` branch uses [GitHub Pages](https://pages.github.com/) to host the following URLs:

+ **HTML manuscript** at https://taylorreiter.github.io/2021-paper-ibd/
+ **PDF manuscript** at https://taylorreiter.github.io/2021-paper-ibd/manuscript.pdf
...
Please attribute by linking to https://github.com/taylorreiter/2021-paper-ibd.
