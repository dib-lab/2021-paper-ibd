...
[![HTML Manuscript](https://img.shields.io/badge/manuscript-HTML-blue.svg)](https://dib-lab.github.io/2021-paper-ibd/)
[![PDF Manuscript](https://img.shields.io/badge/manuscript-PDF-blue.svg)](https://dib-lab.github.io/2021-paper-ibd/manuscript.pdf)
[![GitHub Actions Status](https://github.com/dib-lab/2021-paper-ibd/workflows/Manubot/badge.svg)](https://github.com/dib-lab/2021-paper-ibd/actions)
[![Travis Build Status](https://travis-ci.com/dib-lab/2021-paper-ibd.svg?branch=main)](https://travis-ci.com/dib-lab/2021-paper-ibd)
...
When a commit to the `main` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/dib-lab/2021-paper-ibd/tree/gh-pages) and [`output`](https://github.com/dib-lab/2021-paper-ibd/tree/output) branches.
The `gh-pages` branch uses [GitHub Pages](https://pages.github.com/) to host the following URLs:

+ **HTML manuscript** at https://dib-lab.github.io/2021-paper-ibd/
+ **PDF manuscript** at https://dib-lab.github.io/2021-paper-ibd/manuscript.pdf
...
Please attribute by linking to https://github.com/dib-lab/2021-paper-ibd.
...
Please open [an issue](https://github.com/taylorreiter/2021-paper-ibd/issues) for any question related to licensing.
